...
const colors = require('./shared/preset-mini.8063f1e0.cjs');
const _default = require('./shared/preset-mini.ea3f223e.cjs');
require('./shared/preset-mini.1a56ff70.cjs');
require('./shared/preset-mini.c423dacf.cjs');
require('@unocss/core');
